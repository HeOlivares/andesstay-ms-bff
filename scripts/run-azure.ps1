...
$env:CATALOG_BASE_URL = if ($env:CATALOG_BASE_URL) { $env:CATALOG_BASE_URL } else { "http://localhost:8081" }
$env:RESERVATIONS_BASE_URL = if ($env:RESERVATIONS_BASE_URL) { $env:RESERVATIONS_BASE_URL } else { "http://localhost:8082" }
